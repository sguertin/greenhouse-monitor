...
class sensor:
    ...
    def __init__(self, pi: Pi, gpio, model=DHTAUTO, callback=None):
        """
    ...
    def _validate_DHT11(self, b1, b2, b3, b4) -> tuple[bool, Any, Any]:
        t = b2
        h = b4
    ...
    def _validate_DHTXX(self, b1, b2, b3, b4) -> tuple[bool, float, float]:
        if b2 & 128:
            div = -10.0
        else:
            div = 10.0
