export default class Ajax {
    ...
    */
    static _request(url, requestBody = null, success = null, failure = null, method = 'GET') {
        return new Promise((resolve, reject) => {
            const XHR = new XMLHttpRequest(), handleErrors = (errorMsg, status) => {
                if (failure) {
...
* @return {Promise} A promise that resolves the http request
*/
Ajax.get = (url, success = null, failure = null) => Ajax._request(url, null, success, failure);
/**
...
* @return {Promise} A promise that resolves the http request
*/
Ajax.post = (url, requestBody = null, success = null, failure = null) => Ajax._request(url, requestBody, success, failure, 'POST');
/**
...
* @return {Promise} A promise that resolves the http request
*/
Ajax.put = (url, requestBody = null, success = null, failure = null) => Ajax._request(url, requestBody, success, failure, 'PUT');
/**
...
* @return {Promise} A promise that resolves the http request
*/
Ajax.remove = (url, requestBody = null, success = null, failure = null) => Ajax._request(url, requestBody, success, failure, 'DELETE');
/**
...
* @return {Promise} A promise that resolves the http request
*/
Ajax.option = (url, requestBody = null, success = null, failure = null) => Ajax._request(url, requestBody, success, failure, 'OPTION');
